...
void main()
{
	...
	do
	{
		...
		switch (n)
		{
			...
			case 3:
			{
				/* Каков результат следующего кода. Если там есть ошибка указывает тип ошибки: */

				foo();

				/* Результат - фраза Hello World */
					printf("\n");
					system("pause");
					system("cls");
			...
			case 4:
			{
				...
				/* Попытка применения операции инкрементирования к указателю, хранящему адрес переменной х */
			...
			case 5:
			{
				...
				/*  Массив А и указатель ptr не проинициализированы; 
					неверная работа с указателем и элементами массива  */
			...
			case 6:
			{
				...
				/* Попытка присвоения указателю значения элемента массива;
				   аргументом функции является целочисленная переменная,
				   а возвращаемым значением является значение указателя */
			...
			/* Напишите программу на C, чтобы проверить, может ли Number быть выражен как сумма двух простых чисел*/
				...
				printf("Необходимо проверить может ли число быть представлено как сумма двух простых чисел.\n");
			...
			/*Напишите программу в C, чтобы преобразовать десятичное число в шестнадцатеричное.*/
				...
				printf("Необходимо преобразовать десятичное число в шестнадцатеричное.\n");
				printf("Введите десятичное число: ");
				scanf("%d", &number);

				printf("Число в шестнадцатеричном формате: ");
			...
			до тех пор, пока значение возраста не будет действительным.*/
				...
				printf("Необходимо проверить вхождения возраста в заданный интервал возрастов от 18 до 30 лет.\n");
